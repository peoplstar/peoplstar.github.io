...
테스트 하는 앱은 **DVIA-v2**으로 Vanm Vulnerable iOS의 약자로 iOS 모바일 취약점 진단을 합법적인 환경에서 테스트할 수 있는 플랫폼이며 버전은 `Swift`와 `Objective-C`가 존재합니다.

이번 iOS 모바일 취약점은 `Swift`버전을 통해서 진행하도록 하겠습니다.

해당 사이트를 통해서 다운로드하고 `3utools` 프로그램을 통해 ipa 설치를 진행하면 됩니다.

* [https://github.com/prateek147/DVIA-v2/blob/master/DVIA-v2-swift.ipa](https://github.com/prateek147/DVIA-v2/blob/master/DVIA-v2-swift.ipa)
